...
class BoardCommentReportController(
    ...
    @PostMapping
    fun add(
        @RequestBody addDto: org.parkjg20.specificationbuilder.sample.application.board.action.comment.dto.BoardCommentReportAddDto,
    ): ResponseEntity<org.parkjg20.specificationbuilder.sample.application.board.action.comment.dto.BoardCommentReportDto> {
