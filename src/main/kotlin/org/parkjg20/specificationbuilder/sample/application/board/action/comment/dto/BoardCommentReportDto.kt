package org.parkjg20.specificationbuilder.sample.application.board.action.comment.dto
...
data class BoardCommentReportDto(
    ...
    companion object {
        fun of(entity: BoardCommentReport): org.parkjg20.specificationbuilder.sample.application.board.action.comment.dto.BoardCommentReportDto {

            return org.parkjg20.specificationbuilder.sample.application.board.action.comment.dto.BoardCommentReportDto(
                entity.id!!,
                entity.comment!!.id!!,
                DescribedEnumDto(
                    entity.type!!,
